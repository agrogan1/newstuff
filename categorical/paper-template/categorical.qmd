...
In order to format my results more nicely--**which I should do for an actual paper**--I could copy them into Excel first, format them, and then copy them into Word. There are also some newer ways to make nicely formatted tables in Stata.
