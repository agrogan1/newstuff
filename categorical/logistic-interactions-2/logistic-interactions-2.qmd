...
twoway (function y = exp(x) / (1 + exp(x)), range(-10 10)) ///
  (function y = exp(x + 1) / (1 + exp(x + 1)), range(-10 10)), ///
  legend(order(1 "group 1" 2 "group 2")) ///
  title("Demonstration of Interactive Relationships") ///
  subtitle("In Logistic Regression") ///
  caption("No single parameter can capture the difference slopes between the two groups") 

graph export "demograph.png", replace

```

![Demonstration of Interactive Relationships](demograph.png){ width=75% }
