...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, breakable, toptitle=1mm, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{The logistic regression equation has the desired functional form.}, coltitle=black, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, opacitybacktitle=0.6, opacityback=0, bottomtitle=1mm]
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{logistic.png}
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, breakable, toptitle=1mm, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Exponentiation ``undoes'' the logarithmic transformation.}, coltitle=black, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, opacitybacktitle=0.6, opacityback=0, bottomtitle=1mm]
