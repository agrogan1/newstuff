...
As discussed, the logistic regression equation has the desired functional form to reflect changes in the probability of an outcome that can be either 1 or 0.
