...
ggsave(p1 + 
       ...
       filename = "logistic.png", height = 1.25)
...
save(x, y, myprobability, y2, x3,
     p1, p2, p3, 
     file = "glm.RData")

```

> <span style="background-color:#FFFF00">The currently available drafts of slides for the course can be found [here](https://agrogan1.github.io/newstuff/categorical/README.html) These slides and handouts are free to share and download as long as you cite their source.</span>
