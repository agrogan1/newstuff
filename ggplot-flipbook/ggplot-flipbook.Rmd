...
ggplot(mydata, # data
  ...
  scale_colour_manual(name = "Group", values = c("#FF0099", "#0099FF"),  labels = c("group1", "group2")) + # manual colors 
  theme_minimal() + # theme
  theme(plot.title = element_text(size = 20, color = "#0099FF")) # add to theme
