...
* Consequently, calculations suggest that 36% of the time, when one concludes there is an effect, there is actually no effect. Put another way, despite setting $\alpha = .05$, 36% of cases result in a false positive.
